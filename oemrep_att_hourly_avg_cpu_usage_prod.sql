/* hourly avg cpu usage by the databases in the MIC and PRD groups, hosted on the x4-2 exadata
...
column rollup_timestamp_s format a20 heading "Date"
column bi_mic_avg_cpups format 999G990D000 heading "BI-Mic|ps (cs)"
column dots_mic_avg_cpups format 999G990D000 heading "Dotc-Mic|ps (cs)"
column dots_prd_avg_cpups format 999G990D000 heading "Dots-Prd|ps (cs)"
column evol_mic_avg_cpups format 999G990D000 heading "Evol-Mic|ps (cs)"
column eval_prd_avg_cpups format 999G990D000 heading "Evol-Prd|ps (cs)"
column infra_prd_avg_cpups format 999G990D000 heading "Infra-Prd|ps (cs)"
column misc_mic_avg_cpups format 999G990D000 heading "Misc-Mic|ps (cs)"
column misc_prd_avg_cpups format 999G990D000 heading "Misc-Prd|ps (cs)"
column syn_prd_avg_cpups format 999G990D000 heading "Syn-Prd|ps (cs)"
column total_avg_cpups format 999G990D000 heading "Total|ps (cs)"
column avg_cpu_load format 990D00 heading "Avg CPU|Load %"
...
--  cpu_count,
  ...
  to_char(rollup_timestamp, 'DD/MM/YYYY HH24:MI:SS') rollup_timestamp_s,
  bi_mic_avg_cpups,
  dots_mic_avg_cpups,
  dots_prd_avg_cpups,
  evol_mic_avg_cpups,
  ...
  misc_prd_avg_cpups,
  syn_prd_avg_cpups,
  ( nvl(bi_mic_avg_cpups,0) +
    nvl(dots_mic_avg_cpups,0) +
    nvl(dots_prd_avg_cpups,0) +
    nvl(evol_mic_avg_cpups,0) +
    nvl(eval_prd_avg_cpups,0) +
    nvl(infra_prd_avg_cpups,0) +
    nvl(misc_mic_avg_cpups,0) +
    nvl(misc_prd_avg_cpups,0) +
    nvl(syn_prd_avg_cpups,0)
  ) total_avg_cpups,
  ( ( nvl(bi_mic_avg_cpups,0) +
      nvl(dots_mic_avg_cpups,0) +
      nvl(dots_prd_avg_cpups,0) +
